...
-- Date        : Wed May 16 15:53:19 2018
-- Host        : DESKTOP-0KG3I12 running 64-bit major release  (build 9200)
-- Command     : write_vhdl -mode funcsim -nolib -force -file
--               C:/Users/rinel/Desktop/computer_architecture_project/hdmi_out_test/hdmi_out_test.sim/sim_1/synth/func/xsim/serializer10bit_tb_func_synth.vhd
...
architecture STRUCTURE of hdmi_controller is
  ...
  signal led_reg_n_0 : STD_LOGIC;
  signal mode : STD_LOGIC;
  signal \mode[2]_i_1_n_0\ : STD_LOGIC;
  signal \mode_reg_n_0_[2]\ : STD_LOGIC;
  signal p_0_in : STD_LOGIC_VECTOR ( 1 downto 0 );
  signal \p_0_in__0\ : STD_LOGIC_VECTOR ( 1 downto 0 );
  signal screen_led_OBUF : STD_LOGIC;
  signal screen_led_i_3_n_0 : STD_LOGIC;
  signal screen_led_i_4_n_0 : STD_LOGIC;
  signal screen_led_i_5_n_0 : STD_LOGIC;
  signal screen_led_i_6_n_0 : STD_LOGIC;
  signal screen_led_reg_i_2_n_0 : STD_LOGIC;
  signal screen_led_reg_i_2_n_1 : STD_LOGIC;
  signal screen_led_reg_i_2_n_2 : STD_LOGIC;
  signal screen_led_reg_i_2_n_3 : STD_LOGIC;
  ...
  signal NLW_screen_led_reg_i_2_O_UNCONNECTED : STD_LOGIC_VECTOR ( 3 downto 0 );
  ...
  attribute SOFT_HLUTNM of \color[17]_i_3\ : label is "soft_lutpair15";
  ...
  attribute SOFT_HLUTNM of \x[6]_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \x[7]_i_2\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \x[8]_i_1\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \x[9]_i_1\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \y[0]_i_1\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \y[1]_i_1\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \y[2]_i_1\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \y[3]_i_1\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \y[4]_i_1\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \y[7]_i_2\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \y[8]_i_1\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \y[9]_i_1\ : label is "soft_lutpair16";
begin
...
\color[17]_i_6\: unisim.vcomponents.LUT6
    generic map(
...
screen_led_OBUF_inst: unisim.vcomponents.OBUF
     port map (
      I => screen_led_OBUF,
      O => screen_led
    );
screen_led_i_1: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
screen_led_i_3: unisim.vcomponents.LUT5
    generic map(
      INIT => X"95555555"
    )
        port map (
...
screen_led_i_4: unisim.vcomponents.LUT4
    generic map(
      INIT => X"6000"
    )
        port map (
...
screen_led_i_5: unisim.vcomponents.LUT6
    generic map(
...
screen_led_i_6: unisim.vcomponents.LUT3
    generic map(
      INIT => X"80"
    )
        port map (
...
screen_led_reg: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
screen_led_reg_i_2: unisim.vcomponents.CARRY4
     port map (
      CI => '0',
      CO(3) => screen_led_reg_i_2_n_0,
      CO(2) => screen_led_reg_i_2_n_1,
      CO(1) => screen_led_reg_i_2_n_2,
      CO(0) => screen_led_reg_i_2_n_3,
      CYINIT => '1',
      DI(3 downto 0) => B"0000",
      O(3 downto 0) => NLW_screen_led_reg_i_2_O_UNCONNECTED(3 downto 0),
      S(3) => screen_led_i_3_n_0,
      S(2) => screen_led_i_4_n_0,
      S(1) => screen_led_i_5_n_0,
      S(0) => screen_led_i_6_n_0
    );
